...
const PlexImportModal = ({ onCancel, onComplete }: PlexImportProps) => {
  ...
  const importUsers = async () => {
    ...
    try {
      ...
      toast.error(intl.formatMessage(messages.importfromplexerror));
    } finally {
      setImporting(false);
    }
  };
                  ...
                  <table className="min-w-full">
                    <thead>
                      <tr>
                        ...
                        <th className="plex-bg-primary px-1 py-3 text-left text-xs font-medium uppercase leading-4 tracking-wider text-gray-200 md:px-6">
