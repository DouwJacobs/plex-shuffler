...
const SettingsAbout = () => {
  ...
  return (
    <>
      ...
      />
      <div className="mt-6 rounded-md border plex-border-primary plex-bg-primary bg-opacity-50 p-4 backdrop-blur">
        <div className="flex">
          <div className="flex-shrink-0">
            <InformationCircleIcon className="h-5 w-5 text-white-100" />
          </div>
          <div className="ml-3 flex-1 md:flex md:justify-between">
            ...
            <p className="mt-3 text-sm leading-5 md:mt-0 md:ml-6">
              <a
                ...
                className="whitespace-nowrap font-medium text-white-100 transition duration-150 ease-in-out hover:text-white"
                target="_blank"
                rel="noreferrer"
              >
                GitHub &rarr;
      ...
      <div className="section">
        <List title={intl.formatMessage(messages.supportplexshuffler)}>
          <List.Item title={`${intl.formatMessage(messages.helppaycoffee)} ☕️`}>
            <a
            ...
            <Badge className="ml-2">{intl.formatMessage(messages.preferredmethod)}</Badge>
          </List.Item>
          <List.Item title="">
            <a
