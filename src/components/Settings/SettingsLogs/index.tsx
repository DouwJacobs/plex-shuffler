...
const messages = defineMessages({
  logs: 'Logs',
  logsDescription:
    'You can also view these logs directly via <code>stdout</code>, or in <code>{appDataPath}/logs/plex-shuffler.log</code>.',
  time: 'Timestamp',
  level: 'Severity',
  label: 'Label',
  message: 'Message',
...
const SettingsLogs = () => {
  ...
  const copyLogString = (log: LogMessage): void => {
    ...
    toast.success(intl.formatMessage(messages.copiedLogMessage));
  };
      ...
      <div className="mb-2">
        ...
        <div className="mt-2 flex flex-grow flex-col sm:flex-grow-0 sm:flex-row sm:justify-end">
          <div className="mb-2 flex flex-grow sm:mb-0 sm:mr-2 md:flex-grow-0">
            ...
            <input
              type="text"
              className="rounded-r-only plex-bg-secondary"
              value={searchFilter}
