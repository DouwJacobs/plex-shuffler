...
function Button<P extends ElementTypes = 'button'>(
  ...
  switch (buttonType) {
    case 'primary':
      buttonStyle.push(
        'text-white plex-bg-primary bg-opacity-80 hover:plex-border-white active:bg-opacity-100 input-action'
      );
      break;
    case 'danger':
      buttonStyle.push(
    ...
    case 'ghost':
      buttonStyle.push(
        'text-white bg-transparent border-zinc-600 hover:border-zinc-200 focus:border-zinc-100 active:border-zinc-100'
      );
      break;
    default:
      buttonStyle.push(
